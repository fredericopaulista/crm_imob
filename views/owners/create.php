<div class="space-y-6">
    <div>
        <h2 class="text-base font-semibold leading-7 text-gray-900">Novo Proprietário</h2>
        <p class="mt-1 text-sm leading-6 text-gray-600">Cadastre um novo dono de imóvel.</p>
    </div>

    <form method="POST" action="<?php echo APP_URL; ?>/painel/proprietarios/salvar" class="space-y-6">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div>
                ...
                <select name="status" id="status" required
                    ...
                    <option value="contacted" selected>Ativo</option>
