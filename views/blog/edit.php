<div class="max-w-4xl mx-auto">
    ...
    <form action="<?php echo APP_URL; ?>/painel/blog/atualizar" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 space-y-6">
        ...
        <div>
            ...
            <textarea name="content" id="content" rows="15" class="wysiwyg w-full rounded-lg border-gray-300 focus:border-brand-500 focus:ring-brand-500 font-mono text-sm"><?php echo htmlspecialchars($post['content']); ?></textarea>
        </div>
