-- Seed data for testing the public website
-- 10 Clients and 10 Properties

-- Insert 10 Clients
INSERT INTO clients (name, email, phone, type, status, created_at) VALUES
...
INSERT INTO properties (title, description, type, purpose, price, area, bedrooms, bathrooms, garages, address, neighborhood, city, state, zip_code, status, images, created_at) VALUES
(
